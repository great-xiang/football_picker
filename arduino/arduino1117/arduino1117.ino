...
void loop()
{
    ...
    Serial.print(",");
    control();
    // analogWrite(zuoqian, 100);
    // analogWrite(youqian, 100);
    // analogWrite(zuohou, 0);
    // analogWrite(youhou, 0);
    // delay(2000);
    // analogWrite(zuoqian, 0);
    // analogWrite(youqian, 0);
    // analogWrite(zuohou, 100);
    // analogWrite(youhou, 100);
    // delay(2000);
}
...
void read_speed()
{
    rpm0 = int(number0 / 0.2); //减速比21.3，编码器精度11， num/11/21.3*20*60约等于0.195
    number0 = 0;
    rpm1 = int(number1 / 0.2);
    number1 = 0;
}
